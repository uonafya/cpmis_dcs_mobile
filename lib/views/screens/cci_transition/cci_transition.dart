                              ...
                              if (cciNCCSRegistered == true)
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const Text(
                                      'Period of validatity *',
                                      style: TextStyle(color: kTextGrey),
                                    ),
                                    CustomTextField(
                                        hintText: 'Period of validatity',
                                    ...
                                    if (cciOtherRegistered != false)
                                      Column(
                                        children: [
                                          ...
                                          CustomTextField(
                                              hintText: 'Period of validity',
                                              controller: cciRegValidYrs,
                                              validator: (val) {
                                                if (val!.isEmpty) {
                                                  return "Enter period of validuty";
                                                }
                                                return null;
                                              },
                                              keyboardType:
